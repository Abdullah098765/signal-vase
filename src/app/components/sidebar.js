...
function Sidebar() {
    ...
    return (
        <div className='absolute top-0 h-full'>
            ...
            <div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-52 bg-gray-900 flex-col">
