...
const Card = ({ signal }) => {
    ...
    return (
        <div className="bg-white p-3 card m-3" key={signal._id}>
            ...
            {/* Description */}
            <p className="mt-2 text-sm overflow-ellipsis truncate">{signal.explanation} VIF KSFBS JUBS FIKF S KLJU FBVS JKK VKSH khvjm MB v</p>
