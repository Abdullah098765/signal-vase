...
import { faChartLine, faMale } from '@fortawesome/free-solid-svg-icons';
            ...
            }
            {
                ...
                <img className='max-h-20' src='https://firebasestorage.googleapis.com/v0/b/olx-app-9a451.appspot.com/o/lofgo.PNG?alt=media&token=f6086fb3-a383-4a4d-ab0a-57b628854e37'></img>
                        ...
                        <div class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                            ...
                            }} class={`${selectedLink === 'Home' ? 'text-indigo-400' : ''} flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400   text-white rounded `}>
                            ...
                            <Link href={'/dashboard/profile'} onClick={() => {
                        ...
                        <div class="flex flex-col justify-start      border-b border-gray-600 w-full  ">
                            ...
                            <div id="menu1" class="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
                                <Link href="/following-signals" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52">
                                    ...
                                    <p className="text-base leading-4">Analytics</p>
                                </Link>
