    ...
    return (
        <div>
            ...
            <div class="h-full bg-gray-200 p-8">
                <div class="bg-white rounded-lg shadow-xl p-6 flex lg:flex-row sm:flex-col md:flex-col items-center">
                    <div x-data="{ openSettings: false }" class="absolute right-12 mt-4 rounded">
                    </div>
                    <img src="https://vojislavd.com/ta-template-demo/assets/img/profile.jpg" class="w-40 border-4 border-white rounded-full mx-4" />
                    <div>
                    ...
                    <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8">
                        <div class="flex items-center space-x-4 mt-24 md:mt-3 sm:mt-3">
                ...
                {/* <div class="bg-white rounded-lg shadow-xl pb-8">
                    <div x-data="{ openSettings: false }" class="absolute right-12 mt-4 rounded">
                        ...
                        <div x-show="openSettings" class="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl hidden">
