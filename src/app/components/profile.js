        ...
        <div>
            ...
            <div class="h-full bg-gray-200 p-8">
                <div class="bg-white rounded-lg shadow-xl p-6 flex flex-col lg:flex-row  xl:flex-row items-center">
                    ...
                    <img src={user.profilePicture} class="w-40 border-4 border-white rounded-full mx-4" />
                    <div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <div class="flex flex-col">
                                    <div class="flex items-end">
                                        <span class="text-2xl 2xl:text-3xl font-bold">43.68k</span>
                        ...
                        <div class="px-6 py-6 bg-gray-100 border border-gray-300 rounded-lg shadow-xl">
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <div class="flex flex-col">
                                    <div class="flex items-end">
                                        <span class="text-2xl 2xl:text-3xl font-bold">35.56k</span>
