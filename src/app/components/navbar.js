...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-gray-900 text-white p-1 hidden md:block">
        <div className="container ml-4 mx-auto flex justify-between items-center">
          ...
          <div className="text-2xl font-semibold cursor-pointer flex">
            <button
              name="lines"
              onClick={() => closeSidenav(!isSliderOpen, true)}
              className="hamburger
          ...
          <div className="w-1/3 relative">
            ...
            <div
              ...
              className="absolute inset-y-0 left-0 cursor-pointer  pl-3 flex items-center pointer-events-none"
            >
              {/* Search Icon */}
              <svg
      ...
      <nav
        className={`unvisible-navbar bg-gray-900 text-white pr-2 flex items-center justify-between md:hidden  mb-14`}
      />
      ...
      >
        ...
        {!searchVisible && (
          <div className="flex items-center">
            <Image priority className="m-3" width={80} src={logo} alt="Logo" />
          </div>
        )}
